...
(function (root, factory) {
    ...
    return (function (module_factory) {
        ...
        if (typeof window === "undefined" && typeof process === "object") {
            ...
            var wasm_path = path.join(__dirname, "stdweb_example.wasm");
            var buffer = fs.readFileSync(wasm_path);
            var mod = new WebAssembly.Module(buffer);
            var wasm_instance = new WebAssembly.Instance(mod, instance.imports);
            return instance.initialize(wasm_instance);
        } else {
            var file = fetch("stdweb_example.wasm", {
            ...
            imports: {
                env: {
                    ...
                    "__cargo_web_snippet_5984245de8b6ef88f693ba2383ebf3c2f9718c6c": function ($0) {
                        ...
                        return (o instanceof HTMLCanvasElement) | 0;
                    },
                    ...
                    "__cargo_web_snippet_76c1ee6b34a4c89a8e2052fb46de66eee5144608": function ($0) {
                        var o = Module.STDWEB_PRIVATE.acquire_js_reference($0);
                        return (o instanceof KeyboardEvent && o.type === "keyup") | 0;
                    },
                    ...
                    "__cargo_web_snippet_888b745991f21839297ff985ddd25fb66d630e67": function ($0) {
                        var o = Module.STDWEB_PRIVATE.acquire_js_reference($0);
                        return (o instanceof MouseEvent && o.type === "mousedown") | 0;
                    },
                    "__cargo_web_snippet_89611721005b3de331324f19bedec5df179862e4": function ($0) {
                        var o = Module.STDWEB_PRIVATE.acquire_js_reference($0);
                        return (o instanceof CanvasRenderingContext2D) | 0;
                    },
                    "__cargo_web_snippet_8ac85f6f7d8d2c7a5411feb115a1fc72d713e39c": function ($0, $1, $2, $3, $4, $5, $6, $7) {
                        $0 = Module.STDWEB_PRIVATE.to_js($0);
                        $1 = Module.STDWEB_PRIVATE.to_js($1);
                        $2 = Module.STDWEB_PRIVATE.to_js($2);
                        $3 = Module.STDWEB_PRIVATE.to_js($3);
                        $4 = Module.STDWEB_PRIVATE.to_js($4);
                        $5 = Module.STDWEB_PRIVATE.to_js($5);
                        $6 = Module.STDWEB_PRIVATE.to_js($6);
                        $7 = Module.STDWEB_PRIVATE.to_js($7);
                    ...
                    "__cargo_web_snippet_9d64a695070c583ca1db88f92170810d90b0bb4c": function ($0) {
                        var o = Module.STDWEB_PRIVATE.acquire_js_reference($0);
                        return (o instanceof KeyboardEvent && o.type === "keydown") | 0;
                    },
                    ...
                    "__cargo_web_snippet_b6617e999209f5b71f18f29d9a24d764b1c63845": function ($0) {
                        var o = Module.STDWEB_PRIVATE.acquire_js_reference($0);
                        return (o instanceof MouseEvent && o.type === "mouseup") | 0;
                    },
                    ...
                    "__cargo_web_snippet_d5e30f74cb752784e06bd97a37b1f89b6c3433a7": function ($0, $1, $2) {
                        ...
                        $2 = Module.STDWEB_PRIVATE.to_js($2);
                        Module.STDWEB_PRIVATE.from_js($0, (function () {
                            return ($1).getElementById(($2));
                        })());
                    },
                    "__cargo_web_snippet_d7e8d583ab25cab43e46b8259eaf81008ad7c207": function ($0, $1, $2, $3, $4, $5) {
                        $0 = Module.STDWEB_PRIVATE.to_js($0);
                        $1 = Module.STDWEB_PRIVATE.to_js($1);
                        $2 = Module.STDWEB_PRIVATE.to_js($2);
                        $3 = Module.STDWEB_PRIVATE.to_js($3);
